...
namespace Lab5
{
    public class TaskAsyncAwaitClient
    {
        //http port
        ...
        public TaskAsyncAwaitClient(string page)
        {
            this.page = page;
        }
        ...
        private void Connect(IPEndPoint remoteEP, Socket client)
        {
        ...
        private void Send(Socket client, String page)
        {
