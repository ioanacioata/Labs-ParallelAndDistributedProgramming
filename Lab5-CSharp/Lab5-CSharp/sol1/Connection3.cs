...
namespace Lab5_CSharp
{
    class Connection3
    {
        ...
        public IAsyncResult StartConnection3()
        {
            Socket socket = new Socket(AddressFamily.InterNetwork, SocketType.Stream, ProtocolType.Tcp);
            return socket.BeginConnect(url, 80, requestCallback: RecieveConnection3, state: socket);
        }

        public void RecieveConnection3(IAsyncResult ar)
        {
            Console.WriteLine("Enter ReceiveConnection 3");
            ...
            Console.WriteLine("Exit ReceiveConnection 3");
        }
